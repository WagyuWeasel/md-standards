...
<!-- TEMPLATE: CODE OF CONDUCT
     PURPOSE: Set expectations for behavior in your project's community.
     A code of conduct makes your project welcoming, defines what is
     unacceptable, and explains how violations are handled.
     AUDIENCE: All community members — contributors, maintainers, and users.
     BASE: Adapted from the Contributor Covenant v2.1, the most widely
     adopted code of conduct in open source.
...
<!-- Provide a specific, reachable contact. Do not use a generic
     "the team" — name an email or person. -->

Instances of abusive, harassing, or otherwise unacceptable behavior may
be reported to the community leaders responsible for enforcement at
[CONTACT EMAIL]. All complaints will be reviewed and investigated
promptly and fairly.
